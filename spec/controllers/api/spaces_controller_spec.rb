...
describe Api::SpacesController, 'show' do
  ...
  it "returns the spaces parameters in json" do
    ...
    response.body.should == '{"id":"space-1","name":"space 1","url":"http://test.host/spaces/space-1","memberships":[{"id":"member-1","name":"member 1","url":"http://test.host/spaces/space-1/memberships/member-1","image_url":"http://example.com/pic.jpg","website":"http://member1.test/","bio":null,"profession":"Web","industry":"Web","skills":"all"}]}'
  end
  ...
  it "returns the spaces parameters in jsonp" do
    ...
    response.code.should == '200'
    response.body.should == 'myFunction({"id":"space-1","name":"space 1","url":"http://test.host/spaces/space-1","memberships":[{"id":"member-1","name":"member 1","url":"http://test.host/spaces/space-1/memberships/member-1","image_url":"http://example.com/pic.jpg","website":"http://member1.test/","bio":null,"profession":"Web","industry":"Web","skills":"all"}]});'
  end
